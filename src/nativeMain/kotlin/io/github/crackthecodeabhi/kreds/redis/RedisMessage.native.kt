...
public actual class ArrayHeaderRedisMessage(public actual val length: Long) : RedisMessage
public actual class ArrayRedisMessage(public actual val children: List<RedisMessage>) : RedisMessage {}
public actual class BulkStringHeaderRedisMessage(public actual val bulkStringLength:Int) : RedisMessage
